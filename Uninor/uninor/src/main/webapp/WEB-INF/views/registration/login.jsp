                ...
                <div class="form-container">
                    <form method="post" id="login-form">
                        ...
                        <div class="floating-label-group mt-3">
                            <input type="text" id="number" class="form-control taskName" autocomplete="off"
                                   name="number" required/>
                            <label class="floating-label place-holder">Mobile Number</label>
                            <span id="phoneError" class="error text-danger d-none"></span>
