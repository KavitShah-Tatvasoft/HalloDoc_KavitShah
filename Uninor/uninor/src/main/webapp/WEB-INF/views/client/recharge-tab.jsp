    ...
    <main>
        ...
        <div class="slide-container swiper">
            <div class="slide-content">
                <div class="recharge-text">Popular Plans&nbsp;<span class="popular-plan-count"></span></div>
                ...
                <div class="card swiper-slide d-none clone-swipe-card">
                    <div class="col-12">
                                ...
                                <div class="solution_card">
                                    ...
                                    <div class="solu_title">
                                        <div class="amount-view-btn-flex">
                                            ...
                                            <span class="view-plan-text" id="slide-plan-text">View Plan</span>
                                        </div>
                                    </div>
                                    <div class="solu_description">
                                        <div class="validity-data-flex">
                                            <div class="validity-flex">
                                                ...
                                                <span class="label-value"><span id="slide-validity-text">364</span>&nbsp;days</span>
                                            </div>
                ...
                <div class="card-wrapper swiper-wrapper popular-swiper-body">
