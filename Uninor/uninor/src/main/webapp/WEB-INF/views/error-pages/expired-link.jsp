...
<div class="waiting-container">
    ...
    <p class="description-text text-center">Expired Page</p>
    <p>The page you are trying to access is expired. You have already uploaded the required documents. Please keep patience until the verification process is completed.</p>
