...
<div class="waiting-container">
    <div class="waiting-animation">
        ...
        <img src="<c:url value="/resources/images/unauthorized.png" />" class="verification-img">

    </div>
    <p class="description-text text-center">Account deactivation in progress</p>
    <p>You have created a deactivation request. You cannot access the site now.</p>
