...
<div class="outermost-contianer ">
    ...
    <main>
                        ...
                        <div class="solution_card">
                            ...
                            <div class="solu_description responsive-card">
                                ...
                                <div class="center-recharge-button">
                                    <button type="button" class="read_more_btn" id="recharge-btn-single-card">Update
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="create-new-coupon" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                    ...
                    <form id="newPlanForm" name="newPlanForm">
                        ...
                        <div class="modal-body new-plan-body">
                                ...
                                <div class="search-box">
                                    <div class="form-group">
                                        <select name="planCategory" id="planCategory">
                                            <option value="0">Plan Category</option>
                                            <c:forEach items="${planCategories}" var="categories">
                                                <option value=${categories.planCategoryId}>${categories.categoryName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="rechargeAmount" id="rechargeAmount">
                                        <label for="rechargeAmount">Plan Amount</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="smsAllowance" id="smsAllowance">
                                        <label for="smsAllowance">SMS Allowance</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="dataAllowance" id="dataAllowance">
                                        <label for="dataAllowance">Data Allowance (MB)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="extraData" id="extraData">
                                        <label for="extraData">Extra Data Allowance (MB)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="validity" id="validity">
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                                        <select name="extraDataAvailable" id="extraDataAvailable">
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <label for="extraDataAvailable">Extra Data Available</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                                        <select name="refreshesDaily" id="refreshesDaily">
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <label for="refreshesDaily">Daily Refresh?</label>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="notes-flex-create-plan col-12">
                            <div>Voice Allowance * : Value either Unlimited or Number with suffix minutes is required!
                            </div>
                        </div>
                        <div class="modal-footer new-plan-footer">
                            <button type="submit" class="theme-btn-clr">Create</button>
                            <button type="reset" class="theme-btn-clr">Reset</button>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade" id="update-coupon-modal" data-bs-backdrop="static" data-bs-keyboard="false"
             tabindex="-1"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                    ...
                    <form id="updatePlanForm" name="updatePlanForm">
                        ...
                        <div class="modal-body new-plan-body">
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateRechargeAmount"
                                               id="updateRechargeAmount">
                                        <label for="updateRechargeAmount">Plan Amount</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateSmsAllowance"
                                               id="updateSmsAllowance">
                                        <label for="updateSmsAllowance">SMS Allowance</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateVoiceAllowance"
                                               id="updateVoiceAllowance">
                                        <label for="updateVoiceAllowance">Voice Allowance (Minutes)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateDataAllowance"
                                               id="updateDataAllowance">
                                        <label for="updateDataAllowance">Data Allowance (MB)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateExtraData" id="updateExtraData">
                                        <label for="updateExtraData">Extra Data Allowance (MB)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box">
                                    <div class="form-group">
                                        <input type="text" placeholder=" " name="updateValidity" id="updateValidity">
                                        <label for="updateValidity">Validity Period (Days)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                                        <select name="updateIsAvailable" id="updateIsAvailable">
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <label for="updateIsAvailable">Is Available?</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                                        <select name="updateExtraDataAvailable" id="updateExtraDataAvailable">
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <label for="updateExtraDataAvailable">Extra Data Available</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="search-box select-label-float">
                                    <div class="form-group">
                                        <select name="updateRefreshesDaily" id="updateRefreshesDaily">
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <label for="updateRefreshesDaily">Daily Refresh?</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" id="hiddenCouponTypeValue" name="hiddenCouponTypeValue">
                        <input type="hidden" id="hiddenPlanIdValue" name="hiddenPlanIdValue">
                        <div class="notes-flex-create-plan col-12">
                            <div>Voice Allowance * : Value either Unlimited or Number with suffix minutes is required!
                            </div>
                        </div>
                        <div class="modal-footer new-plan-footer">
                            <button type="submit" class="theme-btn-clr">Update</button>
                            <button type="button" class="theme-btn-clr reset-button-update-modal">Reset</button>
                        </div>
                    </form>
                </div>
