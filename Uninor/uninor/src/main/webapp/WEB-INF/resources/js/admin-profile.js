function validateImageUpload(input) {
    ...
    $.ajax({
        ...
        url: CONTEXT_PATH + '/admin/update-admin-profile-photo',
        type: 'POST',
        processData: false,
        contentType: false,
        dataType: 'json',
...
function getProfileData(){
    $.ajax({
        url: CONTEXT_PATH + '/admin/get-admin-profile-details',
        type: 'GET',
        dataType: 'json',
        success: function (xhr, status, error) {
            var details = xhr['adminProfileDto']
            console.log(details)
            $("#visible-profile-image").attr("src",details.profilePicPath)
            $("#fname").val(details.firstName)
            $("#lname").val(details.lastName)
            $("#mobileNumber").val(details.phone)
...
function updateClientProfileDetails(){
    ...
    $.ajax({
        ...
        url: CONTEXT_PATH + '/admin/update-admin-profile',
        type: 'POST',
