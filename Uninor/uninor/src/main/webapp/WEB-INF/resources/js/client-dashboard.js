...
function getDashboardData() {
    ...
    $.ajax({
        ...
        success: function (xhr, status, error) {
            ...
            if (!responseData.simPrepaid) {
                $(".activate-roaming-btn").addClass("d-none")
                $(".pay-bill-btn").removeClass("d-none")
                ...
                $(".activate-roaming-btn").removeClass("d-none")
                $(".pay-bill-btn").addClass("d-none")
...
function showRechargeModal() {
    ...
    var paymentConfirm = $(".payment-confirm-input").val().toUpperCase()
