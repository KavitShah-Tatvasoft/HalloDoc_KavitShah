	...
	<div
		...
		<div class="date-change-type-flex">
			<div class="date-change-flex">
				<a
					href="javascript:dp.startDate = dp.startDate.addDays(-7); dp.update();setWeekDate();">
			...
			<div class="days-week-month-flex">
				<a href="${pageContext.request.contextPath}/admin/scheduling-day"
					...
					href="${pageContext.request.contextPath}/admin/scheduling-week"
					role="button" class="calendar-type-btn calendar-active">Week</a> <a
					href="${pageContext.request.contextPath}/admin/scheduling-month"
