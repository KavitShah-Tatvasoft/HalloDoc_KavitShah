...
<body onload="getSearchRecordsData()">
	<div
		...
		<button onclick="downloadFilteredData()" role="button" class="export-all-data-btn"> <img
			src="<c:url value='/resources/images/export 1.svg' />" alt="">
		...
		<div class="row p-3 pt-4">
			...
			<div class="col-12 col-md-6 col-lg-3">
				<div class="form-floating mb-3 inp">
					<input type="text" class="form-control input-1 filter-provider-name"
...
<!-- 				<button class="clear-btn select-all shrink-btns">Select All</button> -->
				...
				<button class="search-btn shrink-btns" onclick="getSearchRecordsData()">Search</button>
			</div>
...
<!-- 							By Provider Note</th> -->
						...
						<th scope="col" class="thead width-col15">Delete
							Permanently</th>
					</tr>
				</thead>
					...
					<button class="accordion-button change-target-class" type="button"
						...
						<div class="accordion-button-flex">
							<div class="name-checkbox-flex">
								<span
									class="accordion-row-name acc-name-td">Derek Shah</span>
							</div>

							<small class="acount-type-btn-text acc-address-td">Random Text</small>
						</div>
...
<!-- 							</div> -->
		...
		<div class="accordion accordion-body-empty" id="accordionPanelsStayOpenExample">
