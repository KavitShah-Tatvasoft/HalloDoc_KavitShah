...
<link rel="stylesheet"
	href="<c:url value='/resources/css/sms-log.css' />">
	...
	<div
		...
		<div class="row p-3 pt-4">
			...
			<div class="col-12 col-lg-2 justify-content-end btn-col">
				<div class="row-1-clear-search-btn-flex">
					<button class="search-btn shrink-btns" onclick="filterSMSRecords(true)">Search</button>
		...
		<div class="accordion-item accordion-clone-class d-none">
			<h2 class="accordion-header" id="panelsStayOpen-headingOne">
				<button class="accordion-button change-target" type="button"
					...
					<div class="accordion-button-flex">
						...
						<big class="mb-3"><span class="email-label acc-name">Patel
							...
							class="email-label">Mobile Number: </span> <span
							class="email-text acc-mobile">1234567890</span>
						</small>
			...
			<div id="panelsStayOpen-collapseOne"
				class="change-id accordion-collapse collapse "
		...
		<div class="accordion empty-sms-accordion"
