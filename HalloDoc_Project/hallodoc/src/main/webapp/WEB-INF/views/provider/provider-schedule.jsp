	...
	<div
		...
		<div class="all-region-btns-flex">
			<select onchange="regionFilter()"
				...
				<c:forEach items="${phyRegion }" var="region">
					<option value="${region.regionId }">${region.name }</option>
				</c:forEach>
			</select>

			<div class="btns-flex">
				<a role="button" onclick="hideShiftRepeatDetials()"
					class="three-btns" data-bs-toggle="modal"
					data-bs-target="#create-shift">Add New Shifts</a>
			</div>
		</div>
				...
				<div class="modal-body">
					...
					<form id="create-shift-form">
						<div class="col-12">
							...
							<div class="col-12">
								<div class="form-floating mb-3 inp">
									<select name="Number_Type" disabled id="physician-id-case"
										class="form-control form-select input-2 view-shift-inp physician-name-class">
										<option value="${physicianId}" selected>${physicianName }</option>
