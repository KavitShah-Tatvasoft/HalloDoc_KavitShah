...
public class EmailLog {
		...
		public EmailLog(int emailLogId, String recipientName, String subjectName, String emailId,
				String confirmationNumber, int roleId, int requestId, int adminId, int physicianId,
				LocalDateTime createdDate, LocalDateTime sentDate, boolean isEmailSent, int sentTries, int action) {
			super();
			this.emailLogId = emailLogId;
			this.recipientName = recipientName;
			this.subjectName = subjectName;
